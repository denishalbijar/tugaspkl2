...
function loadJenisBiaya() {
            ...
            $.each(response, function(i, item) {
                tableContent += `
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary btn-sm" onclick="editJenisBiaya(${item.id})">Edit</button>
    ...
    var id = $('#id').val();
    var id_tahun_pelajaran = $('#tahun_pelajaran_id').val();
    var id_jenis_biaya = $('#jenis_biaya_id').val();
